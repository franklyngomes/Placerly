              ...
              >
                ...
                <div className="offcanvas-body align-items-lg-center">
                  <ul className="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      <a className="nav-link scroll-link" href="#services">Services</a>
                    </li>
                    ...
                    <div className="row">
                      <div className="col-lg-11">
                        <span
                          ...
                          data-aos="fade-up"
                          data-aos-delay="0"
                        >Innovative Fintech Solutions</span
                        >
                        <h1
                        ...
                        >
                          ...
                          >Trusted by major companies worldwide</span
                          >
                      ...
                      <div className="col-md-11 mb-4 mb-md-0">
                        ...
                        <div data-aos="fade-up" data-aos-delay="200">
                          ...
                          <p>
                            ...
                            take control of your financial journey with confidence
                            and convenience.
                          </p>
                        </div>
                        <h4
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="fs-5 mb-0">
                            ...
                            delivering secure, efficient, and user-friendly
                            financial services.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        ...
                        >
                          <div className="row">
                            <div className="col-lg-11">
                              <div
                                className="h-100 flex-column justify-content-between d-flex"
                              >
                                <div>
                                  <h2 className="mb-4">Why Choose us</h2>
                                  <p className="mb-5">
                                    Experience the future of finance with our
                                    secure, efficient, and user-friendly financial
                                    ...
                                    financial journey with confidence and
                                    convenience.
                                  </p>
                                </div>
                            ...
                            <div className="col-lg-11">
                              <div className="row">
                                ...
                                >
                                  ...
                                  <p>
                                    Easy navigation with responsive design for
                                    various devices.
                                  </p>
                                </div>
                                <div
                  ...
                  >
                    <div className="p-5 rounded-4 price-table h-100">
                      ...
                      <div className="price mb-4">
                        <strong>$7</strong><span>/ month</span>
                      </div>
                    ...
                    <div className="p-5 rounded-4 price-table popular h-100">
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          <div className="price mb-4">
                            <strong className="me-1">$29</strong><span>/ month</span>
                          </div>
                          <div>
                        ...
                        <div className="col-md-6 pricing-features">
                          ...
                          <ul className="list-unstyled d-flex flex-column gap-3">
                            <li className="d-flex gap-2 align-items-start mb-0">
                              <span
                                className="icon rounded-circle position-relative mt-1"
                              ><i className="bi bi-check"></i></span
                              ><span
                              >Personalized financial insights and reports</span
                              >
                            </li>
                            <li className="d-flex gap-2 align-items-start mb-0">
                              <span
                            ...
                            <li className="d-flex gap-2 align-items-start mb-0">
                              ...
                              ><i className="bi bi-check"></i></span
                              ><span
                              >Access to exclusive investment opportunities</span
                              >
                            </li>
                            <li className="d-flex gap-2 align-items-start mb-0">
                              <span
                ...
                <div className="row g-md-5">
                  <div className="col-md-6 col-lg-3">
                    ...
                    >
                      ...
                      <span
                        className="step-number rounded-circle text-center fw-bold mb-5 mx-auto"
                      >1</span
                      >
                      <div>
                  ...
                  >
                    <div
                      className="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative"
                    >
                  ...
                  >
                    <div
                      className="step-card last text-center h-100 d-flex flex-column justify-content-start position-relative"
                    >
                      <span
                        className="step-number rounded-circle text-center fw-bold mb-5 mx-auto"
                      >4</span
            ...
            <section className="section services__v3" id="services">
              <div className="container">
                ...
                <div className="row g-4">
                  ...
                  >
                    <div
                      className="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5"
                    >
                      <div>
                    ...
                    >
                      ...
                      ><i className="icon-2 bi bi-arrow-right-short"> </i></span
                  ...
                  >
                    ...
                    >
                        ...
                        <p className="mb-4">
                          Fast and accessible lending services that provide personal
                          and business loans through online platforms, simplifying
                  ...
                  >
                    ...
                    >
                        ...
                        <p className="mb-4">
                          User-friendly platforms that allow individuals to invest
                          in stocks, bonds, and other /assets with minimal barriers,
                  ...
                  >
                    ...
                    >
                        ...
                        <p className="mb-4">
                          Services that facilitate the buying, selling, and trading
                          of cryptocurrencies, offering users a gateway to the
                ...
                <div className="row g-4" data-masonry='{"percentPosition": true }'>
                  ...
                  >
                    <div className="testimonial rounded-4 p-4">
                      ...
                      <div
                        className="testimonial-author d-flex gap-3 align-items-center"
                      >
                  ...
                  >
                    <div className="testimonial rounded-4 p-4">
                      <blockquote className="mb-3">
                        ...
                        have made it so much easier to stay on top of my expenses
                        and plan for the future. &rdquo;
                      </blockquote>
                      <div
                        className="testimonial-author d-flex gap-3 align-items-center"
                      >
                  ...
                  >
                    <div className="testimonial rounded-4 p-4">
                      <blockquote className="mb-3">
                        &ldquo; The investment options and portfolio management
                        tools on this platform are top-notch. The variety of choices
                        caters to all types of investors, from conservative to
                        aggressive. I especially appreciate how the tailored
                        recommendations align perfectly with my financial goals.
                        It’s a game-changer for anyone serious about growing their
                        wealth. &rdquo;
                      </blockquote>
                      <div
                        className="testimonial-author d-flex gap-3 align-items-center"
                  ...
                  >
                    <div className="testimonial rounded-4 p-4">
                      <blockquote className="mb-3">
                        &ldquo; The security features are outstanding. Knowing that
                        my financial data is protected gives me peace of mind, and
                        the platform&apos;s efficiency makes it a pleasure to use.
                        &rdquo;
                      </blockquote>
                      <div
                        className="testimonial-author d-flex gap-3 align-items-center"
                    ...
                    <div className="d-flex gap-5 flex-column">
                      ...
                      >
                        ...
                        <span>
                          ...
                          ><strong>+(01 234 567 890)</strong></span
                        >
                      </div>
                      <div
                        className="d-flex align-items-start gap-3"
                      ...
                      >
                        ...
                        <span>
                          ...
                          ><strong>info@mydomain.com</strong></span
                        >
                      </div>
                      <div
                        className="d-flex align-items-start gap-3"
                      ...
                      <div className="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        ...
                        <ul className="list-unstyled">
                          ...
                          <li>
                            ...
                            >Careers
                              <span className="badge ms-1">we&apos;re hiring</span></a
                            >
                          </li>
