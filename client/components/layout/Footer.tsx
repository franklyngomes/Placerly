              ...
              <div className="row g-2">
                ...
                <div className="col-md-6 col-lg-4 mb-4 mb-lg-0 quick-contact">
                  ...
                  <p className="d-flex mb-3">
                    ...
                    <span>123 Main Street Apt 4B Springfield, <br />
                      IL 62701 United States</span>
                  </p>
                  <a className="d-flex mb-3" href="mailto:info@mydomain.com"><i className="bi bi-envelope-fill me-3"></i>
                  <span>info@mydomain.com</span></a>
                  <a className="d-flex mb-3" href="tel://+123456789900"><i className="bi bi-telephone-fill me-3"></i>
                  <span>+1 (234) 5678 9900</span></a>
                  <a className="d-flex mb-3" href="https://freebootstrap.net"><i className="bi bi-globe me-3">
                    </i><span>FreeBootstrap.net</span></a>
                </div>
              </div>
            </div>
          </div>
