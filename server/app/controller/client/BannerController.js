  ...
  async createBanner(req, res) {
    try {
      ...
      if (req.files && req.files.primaryImage) {
        bannerData.primaryImage = req.files.primaryImage.replace(/\\/g,"/")
      }
      if (req.files && req.files.secondaryImage) {
        bannerData.secondaryImage = req.files.secondaryImage.replace(/\\/g,"/");
      }
    ...
    try {
      ...
      if (req.files && req.files.primaryImage && req.files.secondaryImage) {
        if (updateData.primaryImage || updateData.secondaryImage) {
          ...
          updateData.primaryImage = req.files.primaryImage.replace(/\\/g,"/");
          updateData.secondaryImage = req.files.secondaryImage.replace(/\\/g,"/");
        }
      }
