...
router.get("/list-active-banner",AuthCheck, BannerController.listActiveBanner)
...
router.get("/list-active-about",AuthCheck, AboutController.listActiveAbout)
...
router.get("/list-service",AuthCheck, ServiceController.listService)
...
router.get("/list-testimonial",AuthCheck, TestimonialController.listTestimonial)
...
router.get("/list-pricing",AuthCheck, PricingController.listPricing)
...
router.get("/list-faq",AuthCheck, FaqController.listFaq)
